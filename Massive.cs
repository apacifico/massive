...
namespace Massive {
    ...
    public class DynamicModel : DynamicObject {
        ...
        /// <summary>
        /// Builds a set of Insert, Update and Delete commands based on the passed-on objects.
        ...
        /// </summary>
        public virtual DbCommand CreateUpdateCommand(dynamic expando, params object[] key) {
            var settings = (IDictionary<string, object>)expando;
            var sbKeys = new StringBuilder();
